...
```{r}
file_path <- "C:/Users/joel3/OneDrive/Documents/fin550/historic property data.csv"
...
```{r}
file_path <- "C:/Users/joel3/OneDrive/Documents/fin550/predict_property_data.csv"
df.test <- read.csv(file_path)
str(df.test)
head(df.test)
```
Removing columns that are not predictors
...
```{r}
# Create vector of column names from matrix "x"
